...
router.get('/tweets/:tweet_id/replies', authenticated, replyController.getTweetReply)
router.post('/tweets/:tweet_id/replies', authenticated, replyController.postTweetReply)
